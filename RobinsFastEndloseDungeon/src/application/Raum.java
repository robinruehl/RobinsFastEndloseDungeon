...
public class Raum {
	...
	private boolean megasuperboss = false;
	...
	public boolean isMegasuperboss() {
		return megasuperboss;
	}

	public void setMegasuperboss(boolean megasuperboss) {
		this.megasuperboss = megasuperboss;
	}
}
