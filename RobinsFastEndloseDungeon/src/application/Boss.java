...
public class Boss extends Enemy {
	...
	//unterschiedliche Bösse bekommen unterschiedliche stats...
	
	Boss(Player player, boolean endboss) {
		this.name = " Betsie der Seelenfresser";
		this.health = (rand.nextInt(maxHealth)+maxHealth)*((player.level*2)+900);
		this.accuracy = rand.nextInt(40) + 10;
		this.level = player.level;
		this.maxAttackDMG = rand.nextInt(100) + 50 + 50*player.level;
	}
